...
export async function GET(
  ...
  try {
    ...
    // 格式化响应数据
    const question = {
      id: (questionResult.id as unknown) as string,
      title: questionResult.title,
      content: questionResult.content,
      answer: questionResult.answer,
      category_id: (questionResult.category_id as unknown) as string || undefined,
      product_model_id: (questionResult.product_model_id as unknown) as string || undefined,
      ...
      created_by: (questionResult.created_by as unknown) as string || undefined,
      ...
      category: questionResult.category_name ? {
        id: (questionResult.category_id as unknown) as string,
      ...
      product_model: questionResult.product_model_name ? {
        id: (questionResult.product_model_id as unknown) as string,
        name: questionResult.product_model_name,
        category_id: (questionResult.category_id as unknown) as string,
    ...
    const related = relatedQuestions.map((q: RelatedQuestionRow) => ({
      ...
      content: q.content,
      answer: q.answer,
      category_id: (q.category_id as unknown) as string || undefined,
      product_model_id: (q.product_model_id as unknown) as string || undefined,
      software_version: q.software_version || undefined,
      views_count: Number(q.views_count),
      likes_count: Number(q.likes_count),
      created_by: (q.created_by as unknown) as string || undefined,
